        ...
        throws ServletException,IOException
    {
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            out.append("<!DOCTYPE html>\n"
                ...
                + "                        </li>\n"
                + "                        <li class=\"nav-item space-after\">\n"
                + "                            <a class=\"navbar-brand\" onclick=\"changePage('signIn')\" href=\"#\">Sign In</a>\n"
                + "                        </li>\n"
                + "                        <li class=\"nav-item\">\n"
                + "                            <a class=\"navbar-brand\" onclick=\"changePage('register')\" href=\"#\">Register</a>\n"
                + "                        </li>\n"
                + "                    </ul>    \n"
                + "                </div>\n"
                + "        </nav>\n"
                ...
                + "                </ul>\n"
                + "            </div>\n"
                + "            <div id=\"main\" class=\"col-sm-8 main\">"
                + "            <br><br><center><p style=\"font-size:150%; id=\"welcome\"><strong>You have successfully Logged Out</strong></p></center>\n"
